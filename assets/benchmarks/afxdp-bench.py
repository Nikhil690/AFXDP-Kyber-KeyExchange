...
def main():
    ...
    DELAY_BETWEEN_RUNS = 0.02  # seconds (0 = no delay, run back-to-back)
    NUM_RUNS = 5000
    ...
    fig.suptitle('Command Performance Analysis - ./main client', fontsize=16, fontweight='bold')
    ...
    with open(csv_filename, 'w') as f:
        f.write('Run,ExecutionTime(ms)\n')
        for i, time_val in enumerate(times, 1):
            f.write(f'{i},{time_val:.6f}\n')
